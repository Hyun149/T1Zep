...
===========================================================================
✅ 구현할 주요 기능 정리
1. 블록 생성	일정 간격으로 새 블록 생성 
2. 블록 이동	좌우 또는 전후로 자동 이동
3. 클릭 시 정지	마우스 클릭 또는 터치 시 멈춤
4. 겹친 부분 자르기	겹치지 않는 부분은 잘려나감
5. 스택 쌓기	남은 부분 위에 다음 블록 생성
6. 게임오버 판정	완전히 놓치면 끝
7. 점수 증가	블록 성공적으로 놓을 때마다 +1
8. 카메라 상승	스택 높이에 따라 카메라 위로 이동
